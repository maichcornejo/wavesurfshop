					...
					<div class="col-lg-4 col-md-5 align-self-center">
						<div class="row">
							...
							<?php if ( get_theme_mod('shoes_store_elementor_header_button_text') ) : ?>
								<div class="col-lg-3 col-md-3  col-sm-12 align-self-center head-btn text-center text-md-end align-self-center">	
	        		...
	        		<div class="col-lg-2 my-account align-self-center col-md-6 text-md-center text-lg-start">
						<?php if(class_exists('woocommerce')){ ?>
							<?php if ( is_user_logged_in() ) { ?>
								<a href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>" title="<?php esc_attr_e('My Account','shoes-store-elementor'); ?>"><i class="fas fa-sign-in-alt me-2"></i><?php esc_html_e('My Account','shoes-store-elementor'); ?><span class="screen-reader-text"><?php esc_html_e( 'My Account','shoes-store-elementor' );?></span></a>
							<?php }
							else { ?>
								<a href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>" title="<?php esc_attr_e('Login / Register','shoes-store-elementor'); ?>"><i class="fas fa-user me-2"></i><?php esc_html_e('Login / Register','shoes-store-elementor'); ?><span class="screen-reader-text"><?php esc_html_e( 'Login / Register','shoes-store-elementor' );?></span></a>
							<?php } ?>
						<?php }?>
					</div>
				</div>
