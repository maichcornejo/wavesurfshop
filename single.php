  ...
  <div class="container">
    <?php if ( get_theme_mod('shoes_store_elementor_header_page_title' , true)) : ?>
        ...
        <div class="headerimgbox-meta">
          ...
          <?php endwhile; ?>
          <span class="ms-3"><i class="far fa-comments me-2"></i> <?php comments_number( esc_attr('0', 'shoes-store-elementor'), esc_attr('0', 'shoes-store-elementor'), esc_attr('%', 'shoes-store-elementor') ); ?> <?php esc_html_e('comments','shoes-store-elementor'); ?></span>
        </div>
    <?php endif; ?>
