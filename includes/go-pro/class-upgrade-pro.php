		...
		$manager->add_section(
			new Shoes_Store_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.wpelemento.com/products/shoes-store-wordpress-theme/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Shoes_Store_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/theme-documentation/shoes-store-elementor/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Shoes_Store_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/shoes-store-elementor/',
					'priority'    => 5,
				)
			)
		);
