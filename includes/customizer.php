...
if ( class_exists("Kirki")){
	...
	Kirki::add_field( 'theme_config_id', [
        ...
        'label'       => __( 'Logo Size', 'shoes-store-elementor' ),
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_enable_sidebar_animation_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Animation', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_enable_sidebar_animation',
		'label'       => esc_html__( 'Enable or Disable Sidebar Animation', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_enable_footer_animation',
		'label'       => esc_html__( 'Enable or Disable Footer Animation', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_enable_sidebar_sticky_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Sticky Sidebar', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_enable_sticky_sidebar',
		'label'       => esc_html__( 'Enable or Disable Sticky Sidebar', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => false,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_scroll_alignment_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Scroll To Top Position', 'shoes-store-elementor' ) . '</h3>',
	] );

	Kirki::add_field( 'theme_config_id', array(
		'type'        => 'radio-buttonset',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_scroll_alignment',
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => 'right',
		'choices'     => [
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_scroller_border_radius_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Scroll To Top Border Radius', 'shoes-store-elementor' ) . '</h3>',
	] );

	Kirki::add_field( 'theme_config_id', array(
		'type'        => 'slider',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_scroller_border_radius',
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => '3',
		'choices'     => [
			'min'  => 0,
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_cursor_outline_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Dot Cursor', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_cursor_outline',
		'label'       => esc_html__( 'Enable or Disable Dot Cursor', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => false,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_progress_bar_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Progress Bar', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_progress_bar',
		'label'       => esc_html__( 'Enable or Disable Progress Bar', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => false,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_progress_bar_position_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Progress Bar Position', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
		'active_callback'  => [
			[
				'setting'  => 'shoes_store_elementor_progress_bar',
				'operator' => '===',
				'value'    => true,
			],
		]
	...
	Kirki::add_field( 'theme_config_id', array(
		'type'        => 'select',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_progress_bar_position',
		'section'     => 'shoes_store_elementor_additional_setting',
		'default'     => 'top',
		'choices'     => [
			'top' => esc_html__( 'Top', 'shoes-store-elementor' ),
			'bottom' => esc_html__( 'Bottom', 'shoes-store-elementor' ),
		],
		'active_callback'  => [
			[
				'setting'  => 'shoes_store_elementor_progress_bar',
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'shoes_store_elementor_progress_bar_color_heading',
		'section'     => 'shoes_store_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Progress Bar Color', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
		'active_callback'  => [
			[
				'setting'  => 'shoes_store_elementor_progress_bar',
	...
	Kirki::add_field( 'theme_config_id', array(
		'settings'    => 'shoes_store_elementor_progress_bar_color',
		'tab'      => 'general',
		'label'       => __( 'Color', 'shoes-store-elementor' ),
		'type'        => 'color',
		'section'     => 'shoes_store_elementor_additional_setting',
		'transport' => 'auto',
		'default'     => '#ff0101',
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'shoes_store_elementor_show_related_product_heading',
		'section'     => 'shoes_store_elementor_woocommerce_settings',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Related Product', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'shoes_store_elementor_show_related_product',
		'label'       => esc_html__( 'Enable or Disable Related Product', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_woocommerce_settings',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'blog-post',
		'settings'    => 'shoes_store_elementor_enable_post_animation_heading',
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'blog-post',
		'settings'    => 'shoes_store_elementor_enable_post_animation',
		'label'       => esc_html__( 'Enable or Disable Blog Post Animation', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_blog_post',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'blog-post',
		'settings'    => 'shoes_store_elementor_show_pagination_heading',
		'section'     => 'shoes_store_elementor_blog_post',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Blog Post Pagination', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'blog-post',
		'settings'    => 'shoes_store_elementor_show_pagination',
		'label'       => esc_html__( 'Enable or Disable Blog Post Pagination', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_blog_post',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'single-post',
		'settings'    => 'shoes_store_elementor_single_post_date_hide',
		'label'       => esc_html__( 'Enable / Disable Single Post Date', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_blog_post',
		'default'     => '1',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'single-post',
		'settings'    => 'shoes_store_elementor_single_post_author_hide',
		'label'       => esc_html__( 'Enable / Disable Single Post Author', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_blog_post',
		'default'     => '1',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'single-post',
		'settings'    => 'shoes_store_elementor_single_post_comment_hide',
		'label'       => esc_html__( 'Enable / Disable Single Post Comment', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_blog_post',
		'default'     => '1',
		'priority'    => 10,
	] );
    ...
    Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'shoes_store_elementor_show_footer_widget_heading',
		'section'     => 'shoes_store_elementor_footer_section',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Enable / Disable', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'shoes_store_elementor_show_footer_widget',
		'label'       => esc_html__( 'Footer Widget', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_footer_section',
		'default'     => '1',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'shoes_store_elementor_show_footer_copyright',
		'label'       => esc_html__( 'Footer Copyright', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_footer_section',
		'default'     => '1',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'shoes_store_elementor_footer_sticky_heading',
		'section'     => 'shoes_store_elementor_footer_section',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Footer Sticky Copyright', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'switch',
		'settings'    => 'shoes_store_elementor_sticky_copyright_enable',
		'label'       => esc_html__( ' Sticky Copyright Section Enable / Disable', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_footer_section',
		'default'     => '0',
		'priority'    => 10,
		'choices'     => [
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'shoes_store_elementor_footer_widget_alignment_heading',
		'section'     => 'shoes_store_elementor_footer_section',
	...
	Kirki::add_field( 'theme_config_id', array(
		'type'        => 'select',
		'settings'    => 'shoes_store_elementor_footer_widget_alignment',
		'section'     => 'shoes_store_elementor_footer_section',
		'default'     =>[
			'desktop' => 'left',
			'tablet'  => 'left',
		...
		'responsive' => true,
		'label'       => __( 'Widget Alignment', 'shoes-store-elementor' ),
		'transport' => 'auto',
		'choices'     => [
			'center' => esc_html__( 'center', 'shoes-store-elementor' ),
			'right' => esc_html__( 'right', 'shoes-store-elementor' ),
	...
	Kirki::add_section( 'shoes_store_elementor_footer_social_media_section', array(
		'title'          => esc_html__( 'Footer Social Icons', 'shoes-store-elementor' ),
		'panel'    => 'shoes_store_elementor_theme_options_panel',
		'priority'       => 160,
	) );
    ...
    Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'shoes_store_elementor_footer_social_icon_hide_heading',
		'section'     => 'shoes_store_elementor_footer_social_media_section',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Enable or Disable your Footer Social Icon', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'shoes_store_elementor_footer_social_icon_hide',
		'label'       => esc_html__( 'Enable or Disable Social Icon.', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_footer_social_media_section',
		'default'     => false,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'shoes_store_elementor_enable_footer_socail_link_align_heading',
		'section'     => 'shoes_store_elementor_footer_social_media_section',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Footer Social Media Text Align', 'shoes-store-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', array(
		'settings'    => 'shoes_store_elementor_enable_footer_socail_link_align',
		'type'        => 'select',
		'priority'    => 10,
		'label'       => __( 'Text Align', 'shoes-store-elementor' ),
		'section'     => 'shoes_store_elementor_footer_social_media_section',
		'default'     => 'left',
		'choices'     => [
			'center' => esc_html__( 'center', 'shoes-store-elementor' ),
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'priority'    => 10,
		'settings'    => 'shoes_store_elementor_enable_footer_socail_link',
		'section'     => 'shoes_store_elementor_footer_social_media_section',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Footer Social Media Link', 'shoes-store-elementor' ) . '</h3>',
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		...
		'row_label' => [
			'type'  => 'field',
			'value' => esc_html__( 'Footer Social Icons', 'shoes-store-elementor' ),
			'field' => 'link_text',
		],
		'button_label' => esc_html__('Add New Social Icon', 'shoes-store-elementor' ),
		'settings'     => 'shoes_store_elementor_social_links_settings_footer',
		'default'      => '',
		'fields' 	   => [
			'link_text' => [
				'type'        => 'text',
				'label'       => esc_html__( 'Icon', 'shoes-store-elementor' ),
				'description' => esc_html__( 'Add the fontawesome class ex: "fab fa-facebook-f".', 'shoes-store-elementor' ). ' <a href="https://fontawesome.com/search?o=r&m=free&f=brands" target="_blank"><strong>' . esc_html__( 'View All', 'shoes-store-elementor' ) . ' </strong></a>',
				'default'     => '',
			],
			'link_url' => [
				'type'        => 'url',
				'label'       => esc_html__( 'Social Link', 'shoes-store-elementor' ),
				'description' => esc_html__( 'Add the social icon url here.', 'shoes-store-elementor' ),
				'default'     => '',
			],
		],
		'choices' => [
